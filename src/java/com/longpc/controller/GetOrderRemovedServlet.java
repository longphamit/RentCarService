 ...
 * @author ASUS
 */
public class GetOrderRemovedServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("listOrders", orderDAO.getAllOrderRemoved(searchOrderDTO));
            request.setAttribute("getAll", false);
            
        }catch(Exception e){
            e.printStackTrace();
            log("Error at GetOrderRemovedSelected "+e.getMessage());
        }
